        ...
        <div class="sidebar pe-4 pb-3 bg-bk shadow navclz2">
            <nav class="navbar  navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="dashdex.jsp" class="nav-item nav-link active text-dark shadow"><i class="fa fa-tachometer-alt me-2 text-white"></i>Dashboard</a>
                    <a href="profile.jsp" class="nav-item nav-link"><i class="fa fa-user me-2 text-white"></i>Proile</a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-bk border-0 rounded  m-2">
                            ...
                            <hr class="dropdown-divider" />
                            <a href="#" class="dropdown-item text-center text-white-50">See all message</a>
                        </div>
                    </div>
