      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-7">
            ...
            <form action="ContactServlet" method="POST">
              ...
              <div class="p-3 p-lg-5 border shadow">
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <input type="submit" class="btn bg-black text-white rounded-0 btn-lg btn-block"
                      value="Send Message">
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-5 ml-auto">
            <div class="p-4 border-secondary mb-3 shadow">
            ...
            <div class="p-4 border-secondary mb-3 shadow">
              ...
              <p class="mb-0 text">203 Fake St. Mountain View, San Francisco, California, USA</p>
            </div>
