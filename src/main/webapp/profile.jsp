        ...
        <div class="sidebar pe-4 pb-3 bg-bk shadow navclz2">
            <nav class="navbar  navbar-dark">
                <a href="dashdex.jsp" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-white "><i class="fa fa-user-edit me-2 text-white"></i>SHOPPER</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    <a href="dashdex.jsp" class="nav-item nav-link shadow"><i
                            class="fa fa-tachometer-alt me-2 text-white"></i>Dashboard</a>
                    <a href="profile.jsp" class="nav-item nav-link active shadow"><i
                            class="fa fa-user me-2 text-white"></i>Profile</a>
                    <a href="index.jsp" class="nav-item nav-link shadow"><i
                            class="fa fa-home me-2 text-white"></i>Home</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                            ...
                            <div class="card h-100 rounded shadow">
                                ...
                                <div class="p-4 text-white" style="background-color: #191919;">
                                    <div class="d-flex justify-content-evenly text-center py-1">
                                        <div>
                                            <p class="mb-1 h5 text-white">253</p>
                                            <p class="small text-muted mb-0 text-white">Photos</p>
                                        </div>
                                        <div class="px-3">
                                        ...
                                        <div>
                                            <p class="mb-1 h5 text-white">478</p>
                                ...
                                <div class="bg-white rounded h-100 p-4 shadow" >                                
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="form-floating mb-3 col-xl-12 col-md-12">
                                            <input type="text"  class="form-control bg-gry border-0 shadow" id="floatingInput"
                                                placeholder="name@example.com" />
                                            <label style="padding-left: 20px" for="floatingInput">Role</label>
                                        </div>
