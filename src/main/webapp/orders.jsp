        ...
        <div class="sidebar pe-4 pb-3 bg-bk shadow navclz2">
            <nav class="navbar navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="orders.jsp" class="nav-item nav-link active text-dark shadow"><i
                            class="fa fa-truck me-2 text-white"></i>Orders</a>
                    <a href="userpro.jsp" class="nav-item nav-link shadow"><i class="fa fa-user me-2 text-white"></i>Profile</a>
